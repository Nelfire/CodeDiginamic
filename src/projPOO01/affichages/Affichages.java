...
public class Affichages {
	...
	public static void Afficher() {
		...
		System.out.println("Taper 7 pour afficher les interimaires");

		choix = Menus.sc.nextInt();

		switch (choix) {
		case 1:
			AfficherCommun(Affichages.GrouperAffichage());
			break;
		case 2:
			AfficherCommun(Saisir.listsalarie);
			break;
		case 3:
			AfficherCommun(Saisir.listclient);
			break;
		case 4:
			AfficherCommun(Saisir.listfournisseur);
			break;
		case 5:
			AfficherCommun(listpatron);
			break;
		case 6:
			Menus.Menu();
			break;
		case 7:
			AfficherCommun(Saisir.listInterimaire);
			break;
		default:
			Afficher();
			break;
